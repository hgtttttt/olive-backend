...
urlpatterns = [
    ...
    path('changeuserinfo', Personality.change_personality),  # 修改用户信息
    path('changeavatar', Personality.change_avatar),  # 修改用户头像
    path('getuserinfo', Personality.get_personality),  # 得到用户信息
    path('get_other', Personality.get_personality_other),  # 得到他人信息
    path('changepassword', Users.modify_password),  # 修改密码
